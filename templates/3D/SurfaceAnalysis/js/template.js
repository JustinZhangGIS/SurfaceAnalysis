...
define([
    ...
    "config/defaults"
], function (array, declare, kernel, lang, Evented, Deferred, string, domClass, all,
             esriConfig, IdentityManager, esriLang, esriRequest, urlUtils,
             esriPortal, PortalItem, ArcGISOAuthInfo, GeometryService, defaults) {
    ...
    return declare([Evented], {
        ...
        itemConfig: {},
        customUrlConfig: {},
        commonUrlItems: ["webmap", "webscene", "appid", "group", "oauthappid"],
        ...
        _completeApplication: function () {
            ...
            if(this.config.helperServices && this.config.helperServices.geometry && this.config.helperServices.geometry.url) {
                esriConfig.geometryService = new GeometryService(this.config.helperServices.geometry.url);
            }
        },
        _mixinAll: function () {
            /*
        ...
        queryItem: function () {
            ...
            if(this.templateConfig.queryForWebmap) {
                ...
                // use webmap from id
                    ...
                    }).load().then(lang.hitch(this, function () {
        ...
        queryApplication: function () {
            ...
            if(this.config.appid) {
                ...
                }).load().fetchData().then(lang.hitch(this, function (response) {
        ...
        queryOrganization: function () {
            ...
            if(this.templateConfig.queryForOrg) {
                ...
                esriRequest(this.config.sharinghost + "/sharing/rest/portals/self", {
                    query: {
                        "f": "json"
                    }
